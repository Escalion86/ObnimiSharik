...
const SidePanel = ({
  ...
  return (
    <div
      className={
        'fixed laptop:static w-64 h-screen max-h-screen left-0 top-menu laptop:top-0 z-40 transform duration-300 border-t border-primary laptop:border-t-0 bg-white' +
        (!menuOpen
